  ...
  <div id="content-wrapper">
    ...
    <?php $this->load->view("admin/_partials/breadcrumb.php") ?>
      ...
      <div class="card mb-3">
        ...
        <form method="post" action="<?php echo base_url().'admin/kamar_gambar_tambah_aksi'; ?>" enctype="multipart/form-data">
          ...
          <div class="form-group">
                  <div class="col-md-9">
                      File hanya dalam format gif,jpg,png,jpeg dengan resolusi 1024x768 dan max size 100kb. File gambar tidak boleh kosong
                  </div>
            </div>
